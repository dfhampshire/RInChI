...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generation of PHP webpage files - Duncan Hampshire 2017 \n{}".format(__doc__))
    ...
    parser.add_argument("template",help="The template for the files to be created - must include header and footer sections")
