...
from rinchi_tools import Molecule, Reaction, database, utils
...
def get_aldols():
    ...
    r2 = Reaction('RInChI=0.03.1S/C3H6O/c1-3(2)4/h1-2H3<>C6H12O2/c1-5(7)4-6(2,3)8/h8H,4H2,1-3H3/d+')
    #print(r2)
    ...
    for i in database.search_for_roles_advanced('database/rinchi.db', 'rinchis03', changing_subs={c:1},
